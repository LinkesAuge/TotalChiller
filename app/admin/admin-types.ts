...
export type AdminSection = "clans" | "logs" | "users" | "approvals" | "forum" | "rulesDefinitions";
...
export function resolveSection(raw: string | null): AdminSection {
  if (!raw) return "clans";
  const valid: readonly AdminSection[] = ["clans", "logs", "users", "approvals", "forum", "rulesDefinitions"];
