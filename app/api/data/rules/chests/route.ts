...
export async function GET(request: NextRequest): Promise<NextResponse> {
  ...
  try {
    ...
    if (error) {
      captureApiError("GET /api/data/rules/chests", error);
    ...
    captureApiError("GET /api/data/rules/chests", err);
    return apiError("Internal server error.", 500);
  }
}

/**
 * POST /api/data/rules/chests
 *
...
export async function POST(request: NextRequest): Promise<NextResponse> {
  ...
  try {
    ...
    if (error) {
      ...
      captureApiError("POST /api/data/rules/chests", error);
      return apiError("Failed to create chest goal.", 500);
    }

    return NextResponse.json({ data }, { status: 201 });
  } catch (err) {
    captureApiError("POST /api/data/rules/chests", err);
    return apiError("Internal server error.", 500);
  }
}

/**
 * PUT /api/data/rules/chests
 *
...
export async function PUT(request: NextRequest): Promise<NextResponse> {
  ...
  try {
    ...
    if (error) {
      ...
      captureApiError("PUT /api/data/rules/chests", error);
      return apiError("Failed to update chest goal.", 500);
    }

    return NextResponse.json({ data: { id } });
  } catch (err) {
    captureApiError("PUT /api/data/rules/chests", err);
    return apiError("Internal server error.", 500);
  }
}

/**
 * DELETE /api/data/rules/chests
 *
...
export async function DELETE(request: NextRequest): Promise<NextResponse> {
  ...
  try {
    ...
    if (error) {
      captureApiError("DELETE /api/data/rules/chests", error);
      return apiError("Failed to delete chest goal.", 500);
    }

    return NextResponse.json({ data: { deleted: true } });
  } catch (err) {
    captureApiError("DELETE /api/data/rules/chests", err);
    return apiError("Internal server error.", 500);
  }
}
