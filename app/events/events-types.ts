...
/** Predefined banner preset for the event banner picker. */
...
/** Predefined event banners from the game asset library. */
export const EVENT_BANNER_PRESETS: readonly BannerPreset[] = [
