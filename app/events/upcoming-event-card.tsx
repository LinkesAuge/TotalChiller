...
function UpcomingEventCardInner({
  entry,
  onSelectEvent,
  onEditEvent,
  onDeleteEvent,
        ...
        <div className="upcoming-event-content">
          <div className="upcoming-event-top-row">
            ...
            {entry.recurrence_type !== "none" && (
              <span className="upcoming-event-recurrence">{getRecurrenceLabel(entry.recurrence_type, t)}</span>
            )}
          </div>
            ...
            <span className="upcoming-event-meta-item">
              ...
              {isMultiDayEvent(entry.starts_at, entry.ends_at) ? (
                ...
                <>
                  ...
                  <span className="upcoming-event-duration">({formatDuration(entry.starts_at, entry.ends_at)})</span>
                </>
              )}
            </span>
            {entry.location && (
...
/** Memoized upcoming-event card. Skips re-renders when props are stable. */
const UpcomingEventCard = memo(UpcomingEventCardInner);
