...
vi.mock("./dashboard-client", () => ({
  __esModule: true,
  default: () => require("react").createElement("div", { "data-testid": "dashboard-client" }),
}));
...
describe("DashboardPage", () => {
  ...
  it("renders Suspense fallback or resolved content", () => {
    render(<DashboardPage />);
    const skeleton = screen.queryByTestId("page-skeleton");
    const client = screen.queryByTestId("dashboard-client");
