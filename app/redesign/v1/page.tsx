  ...
  return (
    <div style={styles.page}>
      ...
      <nav style={styles.topNav}>
        <div style={styles.topNavInner}>
          ...
          <div style={styles.navLinks}>
            ...
            <a href="#" style={styles.navLink}>Charts</a>
            <a href="#" style={styles.navLink}>Admin</a>
          </div>
      ...
      <div style={styles.clanBanner}>
        ...
        <span style={styles.clanBannerText}>Active Clan: <strong style={{ color: "#e4c778" }}>The Chillers Alpha</strong></span>
        <span style={styles.clanBannerAccount}>Game Account: <strong style={{ color: "#e4c778" }}>DragonKnight99</strong></span>
      </div>
            ...
            {[
              ...
              <div key={i} style={styles.progressItem}>
                ...
                <div style={styles.progressTrack}>
                  <div style={{ ...styles.progressFill, width: `${bar.value}%`, background: `linear-gradient(90deg, ${bar.color}88, ${bar.color})` }} />
                </div>
              </div>
            ))}
          </div>
