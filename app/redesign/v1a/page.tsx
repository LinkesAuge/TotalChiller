    ...
    <div style={s.page}>
      ...
      <div className="v1a-content" style={{ ...s.main, marginLeft: sidebarWidth }}>
        ...
        <div style={s.grid}>
              ...
              {[
                ...
                <div key={i}>
                  ...
                  <div style={s.parchmentItem}>
                    ...
                    <span>{item.text}</span>
                    <span
                      style={{ ...s.itemBadge, background: `linear-gradient(180deg, ${item.color}, ${item.color}cc)` }}
                    >
                      {item.tag}
                    </span>
                  </div>
          ...
          <section style={s.darkCard}>
            <div style={s.darkHead}>
              <h3 style={s.darkTitle}>News Feed</h3>
            </div>
            <div>
              {[
                ...
                <div key={i} style={s.newsRow}>
                  <div>
                    ...
                    <div style={{ fontSize: "0.75rem", color: "#5c5040" }}>{item.time}</div>
                  </div>
                </div>
              ))}
            </div>
          ...
          <section style={{ ...s.darkCard, gridColumn: "span 2" }}>
            <div style={s.darkHead}>
              <h3 style={s.darkTitle}>Clan Progress</h3>
            </div>
        ...
        <footer style={s.footer}>
          <span style={{ color: "#5c5040", fontSize: "0.8rem" }}>
            The Chillers &bull; Community Hub &bull; Total Battle Clan Platform
          </span>
        </footer>
      </div>

      <a href="/redesign" style={s.backLink}>
...
const s: Record<string, React.CSSProperties> = {
  ...
  sidebar: {
    ...
    left: 0,
    height: "100vh",
    background: "linear-gradient(180deg, rgba(10,18,28,0.98), rgba(6,12,20,0.99))",
  ...
  clanName: {
    ...
    textShadow: "0 0 16px rgba(228,199,120,0.3)",
  ...
  sectionDivider: {
    height: 1,
    background: "linear-gradient(90deg, transparent, rgba(201,163,74,0.25), transparent)",
    margin: "6px 8px",
  },
  navItem: {
    display: "flex",
  ...
  navItemActive: {
    background: "linear-gradient(90deg, rgba(201,163,74,0.15), transparent)",
    borderColor: "rgba(201,163,74,0.35)",
    color: "#e4c778",
    borderLeftWidth: 3,
    borderLeftColor: "#c9a34a",
    boxShadow: "0 0 12px rgba(201,163,74,0.1)",
  },
