          ...
          {NAV_ITEMS.map((item, i) => {
            ...
            return (
              ...
              >
                ...
                {item.badge && isExpanded && <span style={st.badge}>{item.badge}</span>}
                {item.badge && !isExpanded && <span style={st.badgeDot} />}
              </a>
            );
          })}
        </nav>
      ...
      <div className="v1b-content" style={{ ...st.content, marginLeft: w }}>
        ...
        <div style={st.grid}>
          <section style={st.parchCard}>
            <div style={st.parchHead}>
              <img
                src="/assets/ui/icon_swords.png"
                alt=""
                style={{ width: 20, height: 20, objectFit: "contain" as const }}
              />
              <h3 style={st.parchT}>Announcements</h3>
              <span style={st.pin}>Pinned</span>
            </div>
          ...
          <section style={st.gCard}>
            ...
            >
              {[
                { v: "12,450", l: "Personal Score" },
                { v: "210,980", l: "Clan Score" },
                { v: "78/90", l: "Chests" },
                { v: "86%", l: "Readiness" },
              ].map((s2, i) => (
                <div
          ...
          <section style={st.dCard}>
            <div style={st.dHead}>
              <h3 style={st.dT}>News Feed</h3>
            </div>
            {["Recruitment opens this week", "Alliance update posted", "War highlights published"].map((t, i) => (
              <div
                key={i}
                style={{ padding: "10px 18px", borderBottom: "1px solid rgba(45,80,115,0.2)", fontSize: "0.88rem" }}
              >
                {t}
              </div>
            ))}
          ...
          <section style={st.dCard}>
            <img
              ...
              alt=""
              style={{ width: "100%", height: 60, objectFit: "cover" as const, opacity: 0.7 }}
            />
            <div style={{ padding: "12px 18px" }}>
              ...
              {[
                ...
                <div
                  key={i}
                  style={{ display: "flex", alignItems: "center", gap: 10, padding: "6px 0", fontSize: "0.88rem" }}
                >
...
const st: Record<string, React.CSSProperties> = {
  ...
  sidebar: {
    ...
    left: 0,
    height: "100vh",
    background: "linear-gradient(180deg, #0e1a28 0%, #08111c 100%)",
    borderRight: "2px solid rgba(201,163,74,0.3)",
  ...
  bannerOverlay: {
    ...
    inset: 0,
    background: "linear-gradient(180deg, rgba(14,26,40,0.5), rgba(8,17,28,0.95))",
  },
  bannerContent: {
    position: "absolute" as const,
    inset: 0,
  ...
  shieldIcon: {
    ...
    flexShrink: 0,
    filter: "drop-shadow(0 0 8px rgba(228,199,120,0.3))",
  },
  ...
  goldTrimLine: {
    flex: 1,
    height: 1,
    background: "linear-gradient(90deg, transparent, rgba(201,163,74,0.4), transparent)",
  },
  ...
  medallion: {
    ...
    background: "linear-gradient(180deg, rgba(15,26,40,0.8), rgba(8,17,28,0.9))",
    display: "flex",
    alignItems: "center",
    justifyContent: "center",
    flexShrink: 0,
  ...
  medallionActive: {
    ...
    boxShadow: "0 0 10px rgba(201,163,74,0.2)",
  },
