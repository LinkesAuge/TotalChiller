  ...
  return (
    <div style={c.page}>
      ...
      <aside className="v1c-sb" style={{ ...c.sb, width: w }}>
        {/* Logo area */}
        <div style={{ ...c.logoArea, padding: open ? "14px 14px 10px" : "14px 8px 10px", justifyContent: open ? "flex-start" : "center" }}>
                ...
                {items.map((item, i) => (
                  ...
                  >
                    ...
                    {item.badge !== undefined && (
                      <span style={{ ...c.bdg, ...(open ? { marginLeft: "auto" } : { position: "absolute" as const, top: 2, right: 2, minWidth: 14, height: 14, fontSize: "0.5rem" }) }}>{item.badge}</span>
                    )}
                  </a>
                ))}
              </div>
        ...
        <div style={c.sbBottom}>
          <button onClick={() => setOpen(!open)} style={{ ...c.toggleBtn, justifyContent: open ? "flex-start" : "center" }} className="v1c-toggle" aria-label="Toggle">
          ...
          <div style={{ ...c.usr, justifyContent: open ? "flex-start" : "center" }}>
            ...
            {open && <div style={{ overflow: "hidden" }}><div style={{ fontSize: "0.78rem", fontWeight: 600, color: "#f2e6c9" }}>DragonKnight99</div></div>}
          </div>
        </div>
      </aside>
      ...
      <div className="v1c-main" style={{ ...c.main, marginLeft: w }}>
        ...
        {/* Hero */}
        <div style={c.hero}>
          <div style={{ position: "absolute" as const, inset: 0, background: "linear-gradient(180deg, rgba(8,13,20,0.3), rgba(8,13,20,0.85))", zIndex: 1 }} />
          ...
          <div style={{ position: "relative" as const, zIndex: 2, textAlign: "center" as const, display: "flex", flexDirection: "column" as const, alignItems: "center", gap: 4 }}>
            ...
            <img src="/assets/ui/decor_line_1.png" alt="" style={{ width: 140, opacity: 0.5, transform: "scaleY(-1)" }} />
          </div>
        </div>

        {/* Grid */}
        <div style={c.grid}>
          <section style={{ gridColumn: "span 2", background: "linear-gradient(180deg, #e8dcc4, #d8cab0)", border: "2px solid #b5a07a", borderRadius: 12, overflow: "hidden" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 10, padding: "11px 16px", background: "linear-gradient(180deg, #5a4325, #3d2d12)", borderBottom: "2px solid #8a6d2f" }}>
              <img src="/assets/ui/icon_swords.png" alt="" style={{ width: 20, height: 20, objectFit: "contain" as const }} />
            ...
            <div style={{ padding: "10px 16px", color: "#3a3020" }}>
              {["War prep tonight at 21:00", "Chest upload deadline Friday", "Tournament registrations open"].map((t, i) => (
                <div key={i}>
                  ...
                  <div style={{ padding: "8px 0", fontSize: "0.88rem", display: "flex", alignItems: "center", gap: 8 }}>
                    <span style={{ color: "#8a6d2f" }}>&#9733;</span>{t}
                  </div>
                </div>
              ))}
            </div>
          ...
          <section style={{ gridColumn: "span 2", background: "linear-gradient(180deg, rgba(22,44,66,0.95), rgba(14,30,45,0.95))", border: "2px solid rgba(201,163,74,0.5)", borderRadius: 12, overflow: "hidden" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 1, background: "rgba(201,163,74,0.15)" }}>
              {[{ v: "12,450", l: "Personal" }, { v: "210,980", l: "Clan" }, { v: "78/90", l: "Chests" }, { v: "86%", l: "Ready" }].map((s2, i) => (
          ...
          <section style={{ background: "linear-gradient(180deg, rgba(22,44,66,0.9), rgba(14,30,45,0.92))", border: "1px solid rgba(45,80,115,0.5)", borderRadius: 12, overflow: "hidden" }}>
          ...
          <section style={{ background: "linear-gradient(180deg, rgba(22,44,66,0.9), rgba(14,30,45,0.92))", border: "1px solid rgba(45,80,115,0.5)", borderRadius: 12, overflow: "hidden" }}>
            ...
            <div style={{ padding: "10px 16px" }}>
              ...
              {[{ n: "War Prep", d: "Today 20:30", cl: "#c94a3a" }, { n: "Guild Meeting", d: "Feb 5", cl: "#4a6ea0" }, { n: "Training", d: "Feb 18", cl: "#4a9960" }].map((e, i) => (
      ...
      <a href="/redesign" style={c.back}>&larr; Back to versions</a>
    </div>
  );
}
...
const c: Record<string, React.CSSProperties> = {
  ...
  sb: { position: "fixed" as const, top: 0, left: 0, height: "100vh", background: "linear-gradient(180deg, rgba(10,17,26,0.99), rgba(6,10,16,1))", borderRight: "1px solid rgba(201,163,74,0.25)", boxShadow: "3px 0 20px rgba(0,0,0,0.35)", display: "flex", flexDirection: "column" as const, zIndex: 100, overflow: "hidden" },
  logoArea: { display: "flex", alignItems: "center", gap: 10, borderBottom: "1px solid rgba(201,163,74,0.15)", flexShrink: 0 },
  ...
  clanCtx: { display: "flex", alignItems: "center", gap: 6, padding: "8px 14px", fontSize: "0.72rem", color: "#7a6e5a", borderBottom: "1px solid rgba(201,163,74,0.1)", flexShrink: 0 },
  ...
  link: { display: "flex", alignItems: "center", gap: 10, textDecoration: "none", color: "#7a6e5a", borderRadius: 6, fontSize: "0.82rem", fontWeight: 500, whiteSpace: "nowrap" as const, overflow: "hidden" },
  ...
  bdg: { minWidth: 16, height: 16, borderRadius: 8, background: "#c94a3a", color: "#fff", fontSize: "0.55rem", fontWeight: 700, display: "flex", alignItems: "center", justifyContent: "center", padding: "0 3px", flexShrink: 0 },
  sbBottom: { flexShrink: 0, padding: "8px 6px 10px", borderTop: "1px solid rgba(201,163,74,0.12)" },
  toggleBtn: { display: "flex", alignItems: "center", gap: 6, width: "100%", padding: "5px 8px", borderRadius: 6, border: "none", background: "transparent", color: "#5c5040", cursor: "pointer", fontSize: "0.78rem", fontWeight: 500, transition: "all 0.12s", marginBottom: 6 },
  usr: { display: "flex", alignItems: "center", gap: 8, padding: "6px 6px", borderRadius: 6, overflow: "hidden" },
  av: { width: 28, height: 28, borderRadius: "50%", background: "linear-gradient(180deg, rgba(201,163,74,0.2), rgba(138,109,47,0.12))", border: "1.5px solid #c9a34a", display: "flex", alignItems: "center", justifyContent: "center", color: "#e4c778", fontSize: "0.65rem", fontWeight: 700, flexShrink: 0 },
  main: { minHeight: "100vh" },
  hdr: { padding: "14px 24px", display: "flex", justifyContent: "space-between", alignItems: "center", borderBottom: "1px solid rgba(201,163,74,0.12)" },
  ...
  cta: { padding: "7px 14px", borderRadius: 8, border: "1px solid rgba(201,163,74,0.4)", background: "linear-gradient(180deg, rgba(201,163,74,0.12), rgba(201,163,74,0.04))", color: "#e4c778", fontSize: "0.8rem", fontWeight: 600, cursor: "pointer" },
