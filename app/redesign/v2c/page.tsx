  ...
  return (
    <div style={z.page}>
      ...
      <aside className="v2c-sb" style={{ ...z.sb, width: w }}>
        ...
        {/* Clan emblem header */}
        <div style={{ ...z.sbHead, padding: open ? "12px 12px 8px" : "12px 6px 8px", flexDirection: open ? "row" as const : "column" as const }}>
          <img src="/assets/vip/components_decor_12.png" alt="" style={{ width: open ? 52 : 42, height: "auto", flexShrink: 0, filter: "drop-shadow(0 2px 8px rgba(201,163,74,0.5))" }} />
          {open && (
            <div>
        ...
        <div style={{ padding: "0 4px", display: "flex", justifyContent: "center", flexShrink: 0 }}>
          <img src="/assets/vip/components_decor_5.png" alt="" style={{ width: open ? "90%" : 48, height: "auto", opacity: 0.5 }} />
        </div>
              ...
              <div key={group}>
                {gi > 0 && (
                  <div style={{ padding: "6px 4px", display: "flex", justifyContent: "center" }}>
                    <img src="/assets/vip/components_decor_5.png" alt="" style={{ width: open ? "70%" : 36, height: "auto", opacity: 0.3 }} />
                  </div>
                )}
                {items.map((item, i) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="v2c-orb" style={z.orbWrap}>
                        <img
                          src={isActive ? "/assets/vip/button_circle_88x87_up_1.png" : "/assets/vip/batler_button_round_up_64x64.png"}
                          alt=""
                          style={z.orbImg}
                        />
                        {item.vipIcon ? (
                          ...
                          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke={isActive ? "#fff" : "#9ab8d0"} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" style={{ position: "relative" as const, zIndex: 1 }}><path d={item.icon} /></svg>
                        )}
                      </div>
                      {open && <span style={{ ...z.navLabel, color: isActive ? "#e4c778" : "#9a8b6f" }}>{item.label}</span>}
                      {item.badge !== undefined && (
                        <span style={{ ...z.badge, ...(open ? { marginLeft: "auto" } : { position: "absolute" as const, top: 0, right: 4, minWidth: 14, height: 14, fontSize: "0.5rem" }) }}>{item.badge}</span>
                      )}
                    </a>
                  );
                })}
        ...
        {/* Bottom */}
        <div style={z.sbBot}>
          <img src="/assets/vip/components_decor_5.png" alt="" style={{ width: open ? "80%" : 40, height: "auto", opacity: 0.3, margin: "0 auto 4px", display: "block" }} />
          <button onClick={() => setOpen(!open)} style={{ ...z.togBtn, justifyContent: open ? "flex-start" : "center" }} aria-label="Toggle">
          ...
          <div style={{ ...z.userRow, justifyContent: open ? "flex-start" : "center" }}>
            <div className="v2c-orb" style={z.orbWrap}>
              ...
              <span style={{ position: "relative" as const, zIndex: 1, color: "#e4c778", fontSize: "0.6rem", fontWeight: 700 }}>DK</span>
            </div>
            {open && (
      ...
      <div className="v2c-main" style={{ ...z.main, marginLeft: w }}>
        ...
        <div style={z.hero}>
          ...
          <img src="/assets/vip/backs_53.png" alt="" style={{ position: "absolute" as const, inset: 0, width: "100%", height: "100%", objectFit: "cover" as const, opacity: 0.15, mixBlendMode: "screen" as const, zIndex: 1 }} />
          <div style={{ position: "relative" as const, zIndex: 2, textAlign: "center" as const, display: "flex", flexDirection: "column" as const, alignItems: "center", gap: 4 }}>
            ...
            <h2 style={{ fontFamily: "'Fontin Sans', serif", fontSize: "1.7rem", fontWeight: 700, color: "#e4c778", textTransform: "uppercase" as const, margin: 0, letterSpacing: "0.06em", textShadow: "0 2px 16px rgba(201,163,74,0.5)" }}>Community Hub</h2>
            ...
            <img src="/assets/vip/components_decor_5.png" alt="" style={{ width: 200, opacity: 0.6, transform: "scaleY(-1)" }} />
          </div>
        </div>
        ...
        <div style={z.grid}>
          ...
          <section style={{ ...z.card, gridColumn: "span 2" }}>
            <div style={z.victoryHead}>
              <img src="/assets/vip/batler_back_victory_1.png" alt="" style={{ position: "absolute" as const, inset: 0, width: "100%", height: "100%", objectFit: "cover" as const, opacity: 0.7 }} />
              <div style={{ position: "relative" as const, zIndex: 1, display: "flex", alignItems: "center", gap: 8, padding: "10px 16px" }}>
                ...
                <h3 style={{ fontFamily: "'Fontin Sans', serif", fontSize: "1rem", fontWeight: 700, color: "#e4c778", flex: 1, margin: 0, textShadow: "0 1px 4px rgba(0,0,0,0.5)" }}>Announcements</h3>
          ...
          <section style={{ ...z.card, gridColumn: "span 2" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 2, padding: 2 }}>
              {[
                ...
                <div key={i} style={{ position: "relative" as const, overflow: "hidden", padding: "16px 10px", textAlign: "center" as const, borderRadius: 6 }}>
                  <img src="/assets/vip/backs_56.png" alt="" style={{ position: "absolute" as const, inset: 0, width: "100%", height: "100%", objectFit: "cover" as const, opacity: 0.3 }} />
                  <div style={{ position: "relative" as const, zIndex: 1 }}>
                    <img src={stat.ico} alt="" style={{ width: 22, height: 22, margin: "0 auto 6px", display: "block", objectFit: "contain" as const }} />
                    <div style={{ fontFamily: "'Fontin Sans', serif", fontSize: "1.3rem", fontWeight: 700, color: "#e4c778", textShadow: "0 0 10px rgba(228,199,120,0.25)" }}>{stat.v}</div>
                    <div style={{ fontSize: "0.62rem", color: "#9a8b6f", marginTop: 2, textTransform: "uppercase" as const }}>{stat.l}</div>
                  </div>
                </div>
              ))}
            </div>
          ...
          <section style={z.card}>
            ...
            {["Recruitment opens this week", "Alliance update posted", "War highlights published"].map((t, i) => (
              <div key={i} style={{ padding: "9px 16px", borderBottom: "1px solid rgba(45,80,115,0.2)", fontSize: "0.88rem", display: "flex", alignItems: "center", gap: 8 }}>
                <img src="/assets/vip/batler_icons_star_glow.png" alt="" style={{ width: 12, height: 12, opacity: 0.5 }} />
                {t}
              </div>
            ))}
          </section>
              ...
              {[
                ...
                <div key={i}>
                  ...
                  <div style={{ position: "relative" as const, height: 14, borderRadius: 4, overflow: "hidden" }}>
                    ...
                    <div style={{ position: "relative" as const, height: "100%", width: `${bar.value}%`, borderRadius: 4, overflow: "hidden" }}>
        ...
        <footer style={{ padding: "20px 24px", textAlign: "center" as const }}>
          <img src="/assets/vip/components_decor_5.png" alt="" style={{ width: 140, opacity: 0.25, margin: "0 auto 8px", display: "block" }} />
          <span style={{ color: "#5c5040", fontSize: "0.78rem" }}>The Chillers &bull; Community Hub</span>
        </footer>
      </div>

      <a href="/redesign" style={z.back}>&larr; Back to versions</a>
    </div>
  );
}
...
const z: Record<string, React.CSSProperties> = {
  ...
  sb: { position: "fixed" as const, top: 0, left: 0, height: "100vh", background: "linear-gradient(180deg, rgba(10,17,26,0.99), rgba(6,10,16,1))", borderRight: "2px solid rgba(201,163,74,0.35)", boxShadow: "4px 0 28px rgba(0,0,0,0.5)", display: "flex", flexDirection: "column" as const, zIndex: 100, overflow: "hidden" },
  sbTexture: { position: "absolute" as const, inset: 0, width: "100%", height: "100%", objectFit: "cover" as const, opacity: 0.15, pointerEvents: "none" as const },
  sbHead: { display: "flex", alignItems: "center", gap: 10, borderBottom: "1px solid rgba(201,163,74,0.25)", flexShrink: 0, position: "relative" as const, zIndex: 1 },
  sbTitle: { fontFamily: "'Fontin Sans', serif", fontSize: "1rem", fontWeight: 700, color: "#e4c778", whiteSpace: "nowrap" as const, textShadow: "0 0 12px rgba(228,199,120,0.3)" },
  ...
  orbWrap: { width: 34, height: 34, borderRadius: "50%", position: "relative" as const, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 },
  ...
  sbBot: { flexShrink: 0, padding: "6px 6px 10px", borderTop: "1px solid rgba(201,163,74,0.2)", position: "relative" as const, zIndex: 1 },
  ...
  topInner: { position: "relative" as const, zIndex: 1, padding: "14px 24px", display: "flex", justifyContent: "space-between", alignItems: "center" },
