      ...
      <aside className="v3c-sb" style={{ ...s.sb, width: w }}>
          ...
          {open && (
            <div style={{ overflow: "hidden" }}>
              ...
              <div style={{ fontSize: "0.62rem", color: "#7a6e5a", display: "flex", alignItems: "center", gap: 4 }}>
                <span
                  style={{ width: 5, height: 5, borderRadius: "50%", background: "#4a9960", display: "inline-block" }}
                />
        ...
        <div style={{ padding: "2px 6px", display: "flex", justifyContent: "center" }}>
          <img
            ...
            alt=""
            style={{ width: open ? "85%" : 38, height: "auto", opacity: 0.45 }}
          />
        </div>
        <nav style={s.nav}>
          {GROUPS.map((group, gi) => {
                      ...
                      {item.badge !== undefined && (
                        <span
                          style={{
                            ...
                            ...(open
                              ? { marginLeft: "auto" }
                              : { top: 2, right: 4, minWidth: 14, height: 14, fontSize: "0.5rem" }),
                            zIndex: 1,
                          }}
                        >
                          {item.badge}
                ...
                {["all", "clan", "global"].map((tab) => (
                  <button
                    ...
                    style={{
                      ...
                      borderRadius: 12,
                      border: "none",
                      background: newsTab === tab ? "rgba(201,163,74,0.15)" : "transparent",
                      color: newsTab === tab ? "#e4c778" : "#5c5040",
                      fontSize: "0.62rem",
                      fontWeight: 600,
                      cursor: "pointer",
...
const s: Record<string, React.CSSProperties> = {
  ...
  sbTitle: {
    ...
    textShadow: "0 0 12px rgba(228,199,120,0.15)",
  },
  ...
  iconGlow: {
    ...
    height: 28,
    borderRadius: "50%",
    background: "radial-gradient(circle, rgba(201,163,74,0.4), transparent 70%)",
    opacity: 0,
  ...
  sbBot: {
    ...
    borderTop: "1px solid rgba(201,163,74,0.15)",
    position: "relative" as const,
    zIndex: 1,
  },
  togBtn: {
